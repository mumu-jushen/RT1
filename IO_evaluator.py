...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--ckpt_dir", type=str, default="D:\\work\\lesson\\Robot transformer\\pytorch_rt1_with_trainer_and_tester-main\\pytorch_rt1_with_trainer_and_tester-main")
    parser.add_argument("-c", "--cam_views", type=str,default="front")
    parser.add_argument("-m", "--model_name", type=str, default="pretrained_rt1.pth")
